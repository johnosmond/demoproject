                ...
                <div class="p-6 bg-white border-b border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <table
                        ...
                        <thead class="bg-gray-50 dark:bg-gray-600">
                            <tr>
                                <th scope="col" class="text-left text-shades-600">Product #</th>
                                <th scope="col" class="text-left text-shades-600">Product Name</th>
                                <th scope="col" class="text-left text-shades-600 max-w-[400px]">Description</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-600">
                            @foreach ($products as $product)
                                <tr
                                    ...
                                    <td class="text-shades-600">{{ $product->product_number }}</td>
                                    <td class="text-shades-600">{{ $product->product_name }}</td>
                                    <td class="text-shades-600 max-w-[400px]">{{ $product->description }}</td>
                                    <td class="text-shades-600">${{ number_format($product->price, 2, '.', ',') }}</td>
                                    <td class="text-center text-shades-600">{{ $product->inactive ? 'Yes' : 'No' }}</td>
                    ...
                    <div class="mt-4 text-gray-600 dark:text-gray-400">
                        Showing {{ $products->firstItem() }} to {{ $products->lastItem() }} of total
